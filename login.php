...
<head>
	...
	<title>Login Admin - Mobil Auto Rapi</title>
...
<body>
	<div id="container" data-background="res/img/bg.jpg">
		<div class="box box-sm">
			<div class="logo">
				<span style="color:white;">Login Admin</span>
				<h1 style="font-size:32pt;letter-spacing:-3px;"><span style="color:#F96E2A"> MAR </span> Car Wash</h1>
			</div>
			<div class="form">
